...
describe('ContributionMediaBar', () => {
  ...
  it('sets selected start and playhead when a media segment is clicked without autoplay', async () => {
    ...
    expect(useGitPulseStore.getState()).toMatchObject({
      selectedStartStepIndex: 3,
      selectedStartDate: pattern.steps[3].date,
  ...
  it('stops playback and resets the playhead to the selected start', async () => {
